...
function About() {
  return (
    <div>
        ...
        <p>I'm currently a 4th-year student at ICCT - Main Campus, aspiring to become a full-stack developer. My primary expertise lies in the MERN stack (MongoDB, Express.js, React.js, and Node.js), and I'm always eager to explore new technologies.</p>
